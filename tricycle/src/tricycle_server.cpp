...
namespace tricycle {
    ...
    void ProxyServiceHandler::Invoke(std::string &_return, const Request &request) {
    ...
    void TricycleServer::Serve(int port) {
        boost::shared_ptr <ProxyServiceHandler> handler(new ProxyServiceHandler());
        boost::shared_ptr <TProcessor> processor(new ProxyServiceProcessor(handler));
